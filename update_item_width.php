...
$it_id = '1776008318';
$new_content = '<div class="insurance-guide" style="font-family:\'Malgun Gothic\', dotum, sans-serif; width:100%; color:#333; line-height:1.6;">
...
$sql = "UPDATE {$g5['g5_shop_item_table']} SET it_explan_example = '" . addslashes($new_content) . "' WHERE it_id = '$it_id'";
