...
define('G5_MYSQL_USER', 'nciame_gnu');
define('G5_MYSQL_PASSWORD', 'mcXT@3NDymqcZm@f');
define('G5_MYSQL_DB', 'nciame_gnu');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '39189d199477319f9c156b36d8be8fe9'); // 토큰 암호화에 사용할 키
