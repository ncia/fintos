...
add_stylesheet('<link rel="stylesheet" id="mode_css" href="'.EYOOM_THEME_URL.'/css/'.$modeStyle.'_mode.css?ver='.G5_CSS_VER.'">',0);
...
<body <?php echo $body_script; ?> <?php if($modeStyle == 'dark') { ?>class="dark-mode"<?php } ?>>
<?php
