...
.shop-order-form .order-member-payment {position:relative;display:flex}
.shop-order-form .order-member-area {flex-grow:1;position:relative}
.shop-order-form .order-member-area .sod-frm-title {position:relative;margin:0 0 30px;padding:20px 0;border-bottom:1px solid #e5e5e5}
.shop-order-form .order-member-area .sod-frm-title h4 {font-size:1.125rem;line-height:1}
.shop-order-form .order-member-area .sod-frm-orderer {padding:0 0 40px}
.shop-order-form .order-member-area .sod-frm-taker {padding:0 0 40px}
...
.shop-order-form .order-table th {width:100px;padding:5px 10px;background:none}
.shop-order-form .order-table td {padding:5px 10px;background:transparent}
.shop-order-form .order-table .label {margin-bottom:0}
.shop-order-form .order-table .input, .shop-order-form .order-table .textarea, .shop-order-form .order-table .btn-e-lg {margin:5px 0}
.shop-order-form .order-table textarea {width:100%;height:100px}
.shop-order-form .order-table a {text-decoration:none}
.shop-order-form .order-payment-area {flex-shrink:0;width:420px;margin-left:30px}
.shop-order-form .order-payment-total {margin-bottom:20px}
.shop-order-form .payment-calc-wrap {position:relative;overflow:hidden;clear:both;border:1px solid #e5e5e5;background:#fff;border-top-left-radius:7px;border-top-right-radius:7px}
...
.shop-order-form .payment-total-box {position:relative;overflow:hidden;clear:both;padding:10px 15px;border:1px solid #e5e5e5;border-top:0;background:#fff;text-align:right;color:#757575;border-bottom-left-radius:7px;border-bottom-right-radius:7px}
...
.shop-order-form .payment-info-box {position:relative;clear:both;padding:10px 15px;border:1px solid #e5e5e5;margin-top:-1px;background:#fff;text-align:right;color:#757575;border-radius:7px}
...
.shop-order-form #display_pay_button .btn_submit {display:block;width:100%;height:50px;line-height:50px;padding:0;background:#3f4678;color:#fff;font-size:.9375rem;font-weight:700;letter-spacing:0;border:0;margin-bottom:15px;border-radius:7px}
.shop-order-form #display_pay_button a.btn01 {display:block;width:100%;height:50px;line-height:50px;padding:0;background:#fff;color:#757575;font-size:.9375rem;font-weight:700;letter-spacing:0;border:1px solid #d5d5d5;border-radius:7px}
...
.shop-order-form #settle_bank {position:relative;padding:15px;border:1px solid #ab0000;margin:20px 0 0;border-radius:7px;display:none}
.shop-order-form #settle_bank .select {margin-bottom:10px}
#settle_bank select {width:100%;height:40px;border:1px solid #ccc;border-radius:7px}
.shop-order-form #settle_bank .input {margin-bottom:0}
.shop-order-form #settle_bank #od_deposit_name {width:100%;height:40px;text-align:left;border:1px solid #ccc;border-radius:7px}
/* Datepicker CSS 수정 */
...
@media (max-width:1199px) {
    .shop-order-form .order-payment-area {width:350px}
}
@media (max-width:991px) {
    .shop-order-form .order-member-payment {display:block}
    .shop-order-form .order-member-area {flex-grow:inherit}
    ...
    .shop-order-form .order-payment-area {flex-shrink:inherit;width:100%;margin-left:0}
}
