...
.product-main-10 .item-main-10-in:hover .product-img-in .second-img {display:block}
...
.product-main-10 .product-description .product-sns ul {margin:0;margin-left:-0.5px;margin-right:-0.5px;padding:0;list-style:none}
.product-main-10 .product-description .product-sns ul:after {content:"";display:block;clear:both}
.product-main-10 .product-description .product-sns ul li {float:left;width:33.33333%;padding:0 0.5px}
.product-main-10 .product-description .product-sns ul li a {display:flex;align-items:center;justify-content:center;white-space:nowrap;width:100%;height:30px;line-height:30px;text-align:center;background:#d5d5d5;color:#fff;font-size:.75rem}
.product-main-10 .product-description .product-sns ul li img {width:12px;height:12px;margin-right:7px}
...
.product-main-10 .product-description-bottom a {font-size:.875rem}
...
.product-main-10 .shop-rgba-yellow {background:#ec8b00}
...
.product-main-10 .shop-rgba-dark {background:#363b43}
.product-main-10 .shop-rgba-default {background:#A6A6A6}
.product-main-10 .rgba-banner-area {position:absolute;top:5px;right:5px}
.product-main-10 .rgba-banner {height:18px;width:70px;line-height:18px;color:#fff;font-size:.6875rem;text-align:center;font-weight:400;position:relative;text-transform:uppercase;margin-bottom:3px;border-radius:2px}
.product-main-10 .item-main-10-in:hover .product-name a {text-decoration:underline}
...
@media (max-width:576px) {
    .product-main-10 .product-description .product-sns ul li a {justify-content:center}
    .product-main-10 .product-description .product-sns ul li a img {margin:0}
    .product-main-10 .product-description .product-sns ul li span {display:none}
}
</style>
            ...
            <div class="item-main-10-in">
                ...
                <div class="product-description">
                    <div class="product-description-in">
                        ...
                        <div class="all-countdown-container" style="background: <?php echo $default['de_all_bodmi_bg_color']; ?>; border: 1px solid <?php echo $default['de_all_bodmi_font_color']; ?>; color: <?php echo $default['de_all_bodmi_font_color']; ?>; padding: 3px 8px; font-size: 11px; margin: 5px 0; border-radius: 4px;">
