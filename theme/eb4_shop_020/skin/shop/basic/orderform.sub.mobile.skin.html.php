...
.shop-order-form .sod-li-wrap .sod-li {background:#fff;border:1px solid #e5e5e5;border-radius:7px;margin:0 0 20px}
...
.shop-order-form .sod-li-wrap .total_price {background:#f5f5f5;border:1px solid #d5d5d5;border-radius:5px;display:block;clear:both;margin:15px;text-align:right;padding:10px 10px;line-height:20px}
...
.shop-order-form .order-payment-total {border:1px solid #ab0000;border-radius:7px;margin-bottom:20px}
.shop-order-form .payment-calc-wrap {position:relative;overflow:hidden;clear:both;border-bottom:1px solid #e5e5e5;background:#fff;border-top-left-radius:7px;border-top-right-radius:7px}
...
.shop-order-form .payment-total-box {position:relative;overflow:hidden;clear:both;padding:10px 15px;background:#fff;text-align:right;color:#757575;border-bottom-left-radius:7px;border-bottom-right-radius:7px}
...
.shop-order-form .order-table th {width:90px;padding:5px 10px;background:none}
...
.shop-order-form .btn_confirm .btn_submit {display:block;width:100%;height:50px !important;line-height:50px;padding:0;background:#3f4678;color:#fff;font-size:.9375rem !important;font-weight:700 !important;letter-spacing:0;border:0 !important;margin-bottom:15px;border-radius:7px}
.shop-order-form .btn_confirm a.btn_cancel {display:block;width:100%;height:50px !important;line-height:50px;padding:0;background:#fff;color:#757575;font-size:.9375rem;font-weight:700;letter-spacing:0;border:1px solid #d5d5d5;border-radius:3px;box-sizing:border-box;border-radius:7px}
...
.shop-order-form #settle_bank {position:relative;padding:15px;border:1px solid #ab0000;margin:20px 0 0;text-align:left;border-radius:7px;display:none}
...
.shop-order-form #settle_bank #od_deposit_name {text-align:left;width:100%;height:40px;border:1px solid #ccc;border-radius:7px}
...
<div class="shop-order-form">
    ...
    <div class="order-member-area">
        ...
        <div class="sod-frm-orderer">
            <div class="headline-short"><h5><strong>주문하시는 분</strong></h5></div>
    ...
    <div id="show_progress" style="display:none;">
        <img src="<?php echo G5_MOBILE_URL; ?>/shop/img/loading.gif" alt="image">
