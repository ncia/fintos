...
.product-main-30 .item-main-30 {position:relative;padding-left:10px;padding-right:10px;outline:none}
.product-main-30 .item-main-30-in {position:relativebackground:#fff;margin-bottom:20px;-webkit-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
...
.product-main-30 .item-main-30-in:hover .product-img-in .second-img {display:block}
...
.product-main-30 .product-description .product-sns ul {margin:0;margin-left:-0.5px;margin-right:-0.5px;padding:0;list-style:none}
.product-main-30 .product-description .product-sns ul:after {content:"";display:block;clear:both}
.product-main-30 .product-description .product-sns ul li {float:left;width:33.33333%;padding:0 0.5px}
.product-main-30 .product-description .product-sns ul li a {display:flex;align-items:center;justify-content:center;white-space:nowrap;width:100%;height:30px;line-height:30px;text-align:center;background:#d5d5d5;color:#fff;font-size:.75rem}
.product-main-30 .product-description .product-sns ul li img {width:12px;height:12px;margin-right:7px}
...
.product-main-30 .product-description-bottom a {font-size:.875rem}
...
.product-main-30 .shop-rgba-yellow {background:#ec8b00}
...
.product-main-30 .shop-rgba-dark {background:#363b43}
.product-main-30 .shop-rgba-default {background:#A6A6A6}
.product-main-30 .rgba-banner-area {position:absolute;top:5px;right:5px}
.product-main-30 .rgba-banner {height:18px;width:70px;line-height:18px;color:#fff;font-size:.6875rem;text-align:center;font-weight:400;position:relative;text-transform:uppercase;margin-bottom:3px;border-radius:2px}
.product-main-30 .item-main-30-in:hover .product-name a {text-decoration:underline}
...
@media (max-width:576px) {
    .product-main-30 .product-description .product-sns ul li a {justify-content:center}
    .product-main-30 .product-description .product-sns ul li a img {margin:0}
    .product-main-30 .product-description .product-sns ul li span {display:none}
}
</style>

<div class="product-main-30">
    <div class="product-main-30-in">
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        <div class="item-main-30">
            <div class="item-main-30-in">
                <?php if ($list[$i]['href']) { ?>
