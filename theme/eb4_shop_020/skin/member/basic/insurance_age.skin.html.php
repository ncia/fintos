    ...
    <div class="mdb-card">
        ...
        <div class="mdb-card-body">
            <div class="register-form">
                <form name="finsurance" action="./counsel_update.php" method="post" onsubmit="return fsubmit(this);" class="eyoom-form">
                    <input type="hidden" name="source" value="insurance_age">
                    ...
                    <div class="gender-selector">
                        <input type="radio" name="c_sex" id="gender_m" value="M">
