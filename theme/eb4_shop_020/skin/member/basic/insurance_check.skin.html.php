<?php
/**
 * skin file : /theme/THEME_NAME/skin/member/basic/insurance_check.skin.html.php
 */
...
<div class="regform-wrapper">
    <div class="mdb-card">
        <div class="mdb-card-header">
            <h1 class="title"><i class="fas fa-clipboard-list m-r-10"></i>보험 통합 조회</h1>
        </div>
        <div class="mdb-card-body">
            <div class="register-form">
                <form name="fcheck" action="./counsel_update.php" method="post" onsubmit="return fsubmit(this);" class="eyoom-form">
                    <input type="hidden" name="source" value="insurance_check">
                    ...
                    <button type="submit" class="submit-btn">보험 통합 조회 신청하기</button>
                </form>
            </div>
        </div>
    </div>
