...
.eb-login .login-btn .btn-e-lg {width:100%;padding:10px 0;border-radius:7px !important;font-weight:bold;font-size:1rem;background:#2d2d38}
...
.login-box .login-box-in .login-form .input .pv-icon {position:absolute;top:10px;right:48px;cursor:pointer}
