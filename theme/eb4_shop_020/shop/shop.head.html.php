...
<div class="wrapper">
    ...
    @media (min-width: 992px) {
        .navbar-nav .nav-special { position: absolute; top: 0; }
        .navbar-nav .nav-special.claim { right: 200px; }
                ...
                <div class="header-title-btn-wrap d-none d-lg-block">
                    ...
                    <div class="header-title-btn btn-group">
                        <a href="#" class="dropdown-toggle"  id="dropdownMemberButton" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo EYOOM_THEME_URL; ?>/image/main/person.svg" alt="">
                    ...
                    <div class="header-title-btn">
                        <a href="<?php echo G5_SHOP_URL; ?>/wishlist.php">
                            ...
                            <img src="<?php echo EYOOM_THEME_URL; ?>/image/main/heart.svg" alt="">
                            <h6>관심상품</h6>
                        </a>
                    </div>
                    <div class="header-title-btn">
                        <a href="<?php echo G5_SHOP_URL; ?>/cart.php">
                            ...
                            <img src="<?php echo EYOOM_THEME_URL; ?>/image/main/cart.svg" alt="">
                            <h6>장바구니</h6>
                        </a>
                    </div>
                </div>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li id="nav_category" class="nav-category dropdown">
                                    ...
                                    <?php if ($eyoom['use_eyoom_shopmenu'] == 'n') { // 영카트 분류가 쇼핑몰 메뉴 출력 ?>
                                        ...
                                        <li class="item-vertical <?php if (isset($menu_1['active']) && $menu_1['active']) echo 'active'; ?> dropdown">
                                            <a href="<?php echo $menu_1['href']; ?>" class="dropdown-toggle">
                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul>
                                            ...
                                            <li class="dropdown-submenu">
                                                <a href="<?php echo G5_URL; ?>/insurance_remodeling.php" class="dropdown-item nav-link"><span class="m-r-5">🛠️</span>보험 리모델링</a>
                                            </li>
                                            <li class="dropdown-submenu">
                                                <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=remodeling_review" class="dropdown-item nav-link"><span class="m-r-5">💬</span>보험 리모델링 후기</a>
                                            </li>
                                        </ul>
                                    </div>
