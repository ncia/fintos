...
<?php 
$es_1652230190 = sql_fetch("select es_state from {$g5['eyoom_slider']} where es_code = '1652230190'");
$ei_active_check = sql_fetch("select count(*) as cnt from {$g5['eyoom_slider_item']} where es_code = '1652230190' and ei_state = '1'");
if ($es_1652230190['es_state'] == '1' && ($ei_active_check['cnt'] > 0 || ($is_admin == 'super' && !G5_IS_MOBILE))) { 
?>
