...
<?php /* ---------- 배너 광고 영역 시작 ---------- */ ?>
<div class="shop-main-section4" style="background: #f8fafc;">
    <div class="container" style="display: flex; justify-content: center; padding: 60px 0;">
        <div style="width: 175.08px; height: 776px; background: #ffffff; border: 2px dashed #cbd5e1; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-size: 18px; font-weight: 700; border-radius: 12px; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.05); text-align: center; padding: 20px;">
            <div style="writing-mode: vertical-rl; text-orientation: upright; letter-spacing: 12px; line-height: 1.5;">
                배너 광고 자리
            </div>
        </div>
    </div>
