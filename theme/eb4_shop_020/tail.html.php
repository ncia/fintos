...
if (currentMode == "dark") {
	...
	if (cssLink) cssLink.href = "<?php echo EYOOM_THEME_URL; ?>/css/dark_mode.css?ver=<?php echo G5_CSS_VER; ?>";
	if (darkModeBtn) darkModeBtn.innerHTML = "<i class='fas fa-sun text-amber'></i><span>라이트모드</span>";
	...
	let cssLink = document.getElementById("mode_css");
	if (cssLink) cssLink.href = "<?php echo EYOOM_THEME_URL; ?>/css/light_mode.css?ver=<?php echo G5_CSS_VER; ?>";
	if (darkModeBtn) darkModeBtn.innerHTML = "<i class='fas fa-moon'></i><span>다크모드</span>";
}
