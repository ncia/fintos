...
<div class="mbmemo-write">
    <div class="mbmemo-content">
        ...
        <div class="text-center m-b-20 margin-bottom-20">
            <h5><strong><?php echo $mbinfo['mb_nick']; ?></strong> 님</h5>
            <p class="text-gray f-s-13r m-t-5 margin-top-5"><?php echo $mbinfo['mb_id']; ?></p>
        </div>
        <section>
            <div class="cont-text-bg m-b-20 margin-bottom-20">
        ...
        <div class="text-center m-t-30 margin-top-30 m-b-30 margin-bottom-30">
