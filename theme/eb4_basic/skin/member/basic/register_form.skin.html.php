...
<div class="register-form">
    ...
    <div class="register-box">
        ...
        <fieldset>
            ...
            <div class="row">
                <section class="col-lg-12">
                    <label class="label">수신설정</label>
                </section>
            </div>
            <div class="row">
                <!-- 마케팅 목적의 개인정보 수집 및 이용 -->
                <section class="col-lg-12 m-b-15">
                    <div class="consent-item">
                        <label class="checkbox">
                            <input type="checkbox" name="mb_marketing_agree" value="1" id="reg_mb_marketing_agree" aria-describedby="desc_marketing" <?php echo $member['mb_marketing_agree'] ? 'checked' : ''; ?> class="marketing-sync">
                            <i></i>(선택) 마케팅 목적의 개인정보 수집 및 이용
                        </label>
                        <button type="button" class="btn-e btn-e-xs btn-e-gray float-end js-open-consent" data-title="마케팅 목적의 개인정보 수집 및 이용" data-template="#tpl_marketing" data-check="#reg_mb_marketing_agree" aria-controls="consentDialog">자세히보기</button>
                        <div class="clearfix"></div>
                        ...
                        <div class="note text-muted m-t-5">(동의일자: <?php echo $member['mb_marketing_date']; ?>)</div>
                        <?php } ?>
            ...
            <div class="row">
                ...
                <section class="col-lg-12 m-b-15">
                    <div class="consent-item">
                        <label class="checkbox">
                            <input type="checkbox" name="mb_promotion_agree" value="1" id="reg_mb_promotion_agree" aria-describedby="desc_promotion" class="marketing-sync parent-promo">
                            <i></i>(선택) 광고성 정보 수신 동의
                        </label>
                        <button type="button" class="btn-e btn-e-xs btn-e-gray float-end js-open-consent" data-title="광고성 정보 수신 동의" data-template="#tpl_promotion" data-check="#reg_mb_promotion_agree" data-check-group=".child-promo" aria-controls="consentDialog">자세히보기</button>
                        <div class="clearfix"></div>
                        <div id="desc_promotion" class="sound_only">광고성 정보(이메일/SMS·카카오톡) 수신 동의의 상위 항목입니다. 자세히보기를 눌러 전문을 확인할 수 있습니다.</div>
                        
                        <!-- 하위 채널 옵션 -->
                        <div class="sub-consent-items m-t-10 p-l-30">
                            <div class="row">
                                <div class="col-lg-6">
                                    <label class="checkbox">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="note text-muted">(동의일자: <?php echo $member['mb_sms_date']; ?>)</div>
                                    <?php } ?>
                                </div>
                                <?php } ?>
                            </div>
            ...
            <div class="row">
                ...
                <section class="col-lg-12 m-b-15">
                    <div class="consent-item">
                        <label class="checkbox">
                            <input type="checkbox" name="mb_thirdparty_agree" value="1" id="reg_mb_thirdparty_agree" aria-describedby="desc_thirdparty" <?php echo $member['mb_thirdparty_agree'] ? 'checked' : ''; ?> class="marketing-sync">
                            <i></i>(선택) 개인정보 제3자 제공 동의
                        </label>
                        <button type="button" class="btn-e btn-e-xs btn-e-gray float-end js-open-consent" data-title="개인정보 제3자 제공 동의" data-template="#tpl_thirdparty" data-check="#reg_mb_thirdparty_agree" aria-controls="consentDialog">자세히보기</button>
                        <div class="clearfix"></div>
                        ...
                        <div class="note text-muted m-t-5">(동의일자: <?php echo $member['mb_thirdparty_date']; ?>)</div>
                        <?php } ?>
