...
url = 'https://insure153.com/1-7%ec%a2%85-%ec%88%98%ec%88%a0-%eb%b6%84%eb%a5%98%ed%91%9c/'
...
# Using the previous logic to parse embedded tables
...
# Remapping for backend
# By inspecting standard TablePress outputs or just looking at what headers are:
# Assuming headers: '코드', '수술명', '종류' (or similar like '종별', '수술코드')
# We'll normalize keys. We'll dump it as raw first.
with open('c:/xampp/htdocs/gnu/shop/surgery_1_7_data.json', 'w', encoding='utf-8') as f:
    json.dump(data, f, ensure_ascii=False, indent=4)
print("Parsed and saved 1-7 surgery data to surgery_1_7_data.json")
