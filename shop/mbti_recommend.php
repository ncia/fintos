...
<div class="container m-t-30 m-b-50">
    ...
    <div class="text-center m-b-40">
        <div class="m-b-30 mx-auto" style="max-width: 800px;">
            <img src="<?php echo EYOOM_THEME_URL; ?>/image/quiz/mbti_intro_visual.png" alt="MBTI 추천 가이드" class="img-fluid rounded-3 shadow-sm border">
        </div>
