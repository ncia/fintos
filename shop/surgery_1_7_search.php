...
<div class="surgery-search-container container m-t-30 m-b-50">
    <div class="main-heading m-b-30">
        <h2 class="f-s-24 fw-600"><i class="fas fa-search-plus text-success m-r-10"></i><strong>1-7종 수술명</strong> <span class="text-muted">검색</span></h2>
    </div>
            ...
            <div class="row g-3 align-items-end">
                <div class="col-lg-2 col-md-6">
                    ...
                    <select id="surgeryMode" class="form-select border-gray-200 py-2 rounded-3">
                        ...
                        <option value="1-7" selected>1-7종 수술</option>
        ...
        <div id="surgeryResultArea" class="px-2 px-md-4 pb-4">
            <div class="text-center py-5">
                <div class="p-5">
                    ...
                    <h5 class="text-dark fw-bold mb-2">1-7종 수술 정보를 검색해 보세요!</h5>
...
$(document).ready(function() {
    function searchSurgery(page = 1) {
        ...
        $.ajax({
            url: '<?php echo G5_SHOP_URL; ?>/surgery_1_7_search_api.php',
            type: 'GET',
            data: {
                q: q,
                code: code,
