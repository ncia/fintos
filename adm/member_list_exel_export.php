    ...
    $configs = [
        1 => [
            ...
            'fields'  => ['mb_id', 'mb_name', 'mb_nick', 'mb_hp', 'mb_tel', 'mb_email', 'mb_addr1', 'mb_level', 'mb_point', 'mb_datetime', 'mb_intercept_date',
                            'mb_kakaotalk','mb_kakaotalk_date', 'mb_sms','mb_sms_date', 'mb_marketing_agree', 
...
function member_export_get_data($params) 
{
    ...
    $sqlTransformMap = [
        ...
        'mb_kakaotalk' => "IF(mb_kakaotalk = '1', '동의', '미동의') AS mb_kakaotalk",
        'mb_kakaotalk_date' => "IF(mb_kakaotalk != '1' OR mb_kakaotalk_date = '0000-00-00 00:00:00', '', mb_kakaotalk_date) AS mb_kakaotalk_date",
