...
$it_ins_type = isset($_POST['it_ins_type']) && is_array($_POST['it_ins_type']) ? implode(',', $_POST['it_ins_type']) : (isset($_POST['it_ins_type']) ? $_POST['it_ins_type'] : '');
$it_ins_refund = isset($_POST['it_ins_refund']) && is_array($_POST['it_ins_refund']) ? implode(',', $_POST['it_ins_refund']) : (isset($_POST['it_ins_refund']) ? $_POST['it_ins_refund'] : '');
$it_ins_pay_term = isset($_POST['it_ins_pay_term']) ? strip_tags(clean_xss_attributes($_POST['it_ins_pay_term'])) : '';
$it_ins_period = isset($_POST['it_ins_period']) ? strip_tags(clean_xss_attributes($_POST['it_ins_period'])) : '';
$it_ins_renewal = isset($_POST['it_ins_renewal']) ? strip_tags(clean_xss_attributes($_POST['it_ins_renewal'])) : '';
...
$sql_common = " ca_id               = '$ca_id',
                ...
                it_9                = '$it_9',
                it_10               = '$it_10',
                it_ins_type         = '$it_ins_type',
                it_ins_refund       = '$it_ins_refund',
                it_ins_pay_term     = '$it_ins_pay_term',
                it_ins_period       = '$it_ins_period',
                it_ins_renewal      = '$it_ins_renewal'
                ";
