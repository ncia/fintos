...
$check_keys = array(
    ...
    'cf_syndi_token' => '',
    'cf_syndi_except' => '',
    'cf_googlesheet_use' => 'int',
    'cf_googlesheet_url' => 'text',
    'cf_form_mail_use' => 'int',
    'cf_form_mail' => 'char',
    'cf_admin_email_name' => 'char',
    'cf_permit_level' => 'int',
...
$sql = " update {$g5['config_table']}
            set cf_title = '{$cf_title}',
                ...
                cf_use_admlogin = '{$_POST['cf_use_admlogin']}',
                cf_admlogin_ip = '{$_POST['cf_admlogin_ip']}',
                ...
                cf_googlesheet_use = '{$_POST['cf_googlesheet_use']}',
                cf_googlesheet_url = '{$_POST['cf_googlesheet_url']}',
                cf_form_mail_use = '{$_POST['cf_form_mail_use']}',
                cf_form_mail = '{$_POST['cf_form_mail']}',
