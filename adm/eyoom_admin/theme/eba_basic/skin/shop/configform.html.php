        ...
        <div class="tab-pane" id="anc_scf_payment" role="tabpanel" aria-labelledby="anc_scf_payment_tab">
            <div class="adm-form-table m-b-20">
                ...
                <div class="adm-form-tr pg_vbank_url" id="inicis_vbank_url">
                    <div class="adm-form-td td-l">
                        <label class="label">KG이니시스 가상계좌<br>입금통보 URL</label>
                    </div>
                    <div class="adm-form-td td-r">
                ...
                <div class="adm-form-tr pg_vbank_url" id="nicepay_vbank_url">
                    <div class="adm-form-td td-l">
                        <label class="label">NICEPAY 가상계좌<br>입금통보 URL</label>
                    </div>
                    <div class="adm-form-td td-r">
                ...
                <div class="adm-form-tr pg_vbank_url" id="toss_vbank_url">
                    <div class="adm-form-td td-l">
                        <label class="label">토스페이먼츠 가상계좌<br>입금통보 URL</label>
                    </div>
                    <div class="adm-form-td td-r">
                        <?php echo G5_SHOP_URL; ?>/settle_toss_common.php<br>
                        <div class="note"><strong>Note:</strong> 토스페이먼츠 가상계좌 사용시 다음 주소를 <strong><a href="https://app.tosspayments.com/" target="_blank">토스페이먼츠 상점관리자</a> &gt; 개발자센터 &gt; 웹훅 &gt; 웹훅 등록하기에 URL</strong>에 넣으시고, <strong>구독할 이벤트를 [DEPOSIT_CALLBACK]</strong>을 선택하셔야 상점에 자동으로 입금 통보됩니다.</div>
                    </div>
                </div>
                <div class="adm-form-tr">
                    <div class="adm-form-td td-l">
                ...
                <div class="adm-form-tr adm-sm-100">
                    ...
                    <div class="adm-form-td td-r">
                        ...
                        <div class="m-b-5 de_pg_tab">
                            ...
                            <span class="<?php if($default['de_pg_service'] == 'lg') echo 'tab-current'; ?>"><a href="#lg_info_anchor" class="btn-e btn-e-lg btn-e-dark btn-e-brd m-b-5" data-value="lg" title="토스페이먼츠(구버전) 선택하기">토스페이먼츠(구버전)</a></span>
                            <span class="<?php if($default['de_pg_service'] == 'toss') echo 'tab-current'; ?>"><a href="#lg_info_anchor" class="btn-e btn-e-lg btn-e-dark btn-e-brd m-b-5" data-value="toss" title="토스페이먼츠 선택하기">토스페이먼츠</a></span>
                ...
                <div class="adm-form-tr pg_info_fld lg_info_fld">
                    <div class="adm-form-td td-l">
                        <label for="cf_lg_mert_key" class="label">토스페이먼츠(구버전) MERT KEY</label>
                    </div>
                    <div class="adm-form-td td-r">
                        ...
                        <div class="note"><strong>Note:</strong> 토스페이먼츠(구버전) 상점 MertKey는 상점관리자 -> 개발자센터 -> API키 -> 머트 키에서 확인하실 수 있습니다.<br>예) 95160cce09854ef44d2edb2bfb05f9f3</div>
                    </div>
                </div>
                <div class="adm-form-tr pg_info_fld lg_info_fld_v2">
                    <div class="adm-form-td td-l">
                        <label for="cf_toss_client_key" class="label">토스페이먼츠 API Client Key</label>
                    </div>
                    <div class="adm-form-td td-r">
                        <label for="cf_toss_client_key" class="input">
                            <input type="text" name="cf_toss_client_key" value="<?php echo get_sanitize_input($config['cf_toss_client_key']); ?>" id="cf_toss_client_key">
                        </label>
                        <div class="note"><strong>Note:</strong> 토스페이먼츠 API 클라이언트 키는 상점관리자 -> 개발자센터 -> API키 -> 클라이언트 키에서 확인하실 수 있습니다. 예) live_ck_tosspayment<br>실결제용 [라이브] 키와 테스트용 [테스트] 키는 서로 다르므로, <b>테스트로 결제시에는 [테스트] 키</b>로 변경하여 사용해주시기 바랍니다. 예) 테스트 키: test_ck_tosspayment</div>
                    </div>
                </div>
                <div class="adm-form-tr pg_info_fld lg_info_fld_v2">
                    <div class="adm-form-td td-l">
                        <label for="cf_toss_secret_key" class="label">토스페이먼츠 API Secret Key</label>
                    </div>
                    <div class="adm-form-td td-r">
                        <label for="cf_toss_secret_key" class="input">
                            <input type="text" name="cf_toss_secret_key" value="<?php echo get_sanitize_input($config['cf_toss_secret_key']); ?>" id="cf_toss_secret_key">
                        </label>
                        <div class="note"><strong>Note:</strong> 토스페이먼츠 API 시크릿 키는 상점관리자 -> 개발자센터 -> API키 -> 시크릿 키에서 확인하실 수 있습니다. 예) live_sk_tosspayment<br>실결제용 [라이브] 키와 테스트용 [테스트] 키는 서로 다르므로, <b>테스트로 결제시에는 [테스트] 키</b>로 변경하여 사용해주시기 바랍니다. 예) 테스트 키: test_sk_tosspayment</div>
                    </div>
                </div>
                ...
                <div class="adm-form-tr adm-sm-100">
                    ...
                    <div class="adm-form-td td-r">
                        ...
                        <div class="scf_cardtest toss_cardtest m-b-10">
                            <a href="https://app.tosspayments.com/" target="_blank" class="btn-e btn-e-md btn-e-dark m-b-5">상점 관리자</a>
                        </div>
                        ...
                        <div id="scf_cardtest_tip" class="m-t-20">
                            ...
                            <div id="toss_cardtest_tip" class="scf_cardtest_tip_adm scf_cardtest_tip_adm_hide m-b-20">
                                <p class="li-p-sq">테스트결제의 <a href="https://app.tosspayments.com/" target="_blank">상점관리자</a> 로그인 정보는 실결제용 키와는 다르니 반드시 <b>[테스트] API 연동 키</b>로 로그인해야 합니다. 예) test_ck_toss</p>
                            </div>
